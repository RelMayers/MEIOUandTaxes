...
trade_nodes = {'Pacific': 1, 'Australia': 2, 'Huai He': 3, 'Zhongyuan': 4, 'Jiangnan': 5, 'East Sea': 6, 'Amur': 7, 'Yellow Sea': 8, 'Nippon': 9, 'Jiangxi': 10, 
               'Fujian': 11, 'Eastern Siberia': 12, 'Huabei': 13, 'Western Seaboard': 14, 'Western Valley': 15, 'Gulf of Tehuantepec': 16, 'Valley of Mexico': 17, 
               ...
               'Abyssinian Highlands': 59, 'Upper Nile': 60, 'Iran': 61, 'Arabian Peninsula': 62, 'Arabian Gulf': 63, 'Red Sea': 64, 'Central Africa': 65, 'Monomotapa': 66, 
...
# the British Isles
expeditions_list.append(Expedition('british_isles', 'the British Isles', 0, 'Jumping Node', ['Channel', 'Norwegian Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 25), ('Strait of Gibraltar', 25), ('Alboran Sea', 25), ('Gulf of Lion', 25), ('Bay of Biscay', 23), ('France', 23), ('North Sea', 23), ('Channel', 23), ('Norwegian Sea', 23), ('Western Baltic', 23), ('Berber Coast', 25), ('Maghreb', 25), ('Tyrrenean Sea', 25), ('Rhineland', 23), ('Upper Danube', 23), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ...
     ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Upper Nile', 32), ('Jazira', 32), ('Arabian Peninsula', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Northern Europe
expeditions_list.append(Expedition('northern_europe', 'Northern Europe', 0, 'Jumping Node', ['Norwegian Sea', 'North Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 25), ('Strait of Gibraltar', 25), ('Alboran Sea', 25), ('Gulf of Lion', 25), ('Bay of Biscay', 23), ('France', 23), ('North Sea', 23), ('Channel', 23), ('Norwegian Sea', 23), ('Western Baltic', 23), ('Berber Coast', 25), ('Maghreb', 25), ('Tyrrenean Sea', 25), ('Rhineland', 23), ('Upper Danube', 23), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# France
expeditions_list.append(Expedition('france', 'France', 0, 'Jumping Node', ['Channel', 'France', 'Bay of Biscay']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 25), ('Alboran Sea', 25), ('Gulf of Lion', 25), ('Bay of Biscay', 23), ('France', 23), ('North Sea', 23), ('Channel', 23), ('Norwegian Sea', 23), ('Western Baltic', 23), ('Berber Coast', 25), ('Maghreb', 25), ('Tyrrenean Sea', 25), ('Rhineland', 23), ('Upper Danube', 23), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Iberia
expeditions_list.append(Expedition('iberia', 'Iberia', 0, 'Jumping Node', ['Bay of Biscay', 'Strait of Gibraltar']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 23), ('Alboran Sea', 25), ('Gulf of Lion', 25), ('Bay of Biscay', 25), ('France', 25), ('North Sea', 25), ('Channel', 25), ('Norwegian Sea', 25), ('Western Baltic', 25), ('Berber Coast', 25), ('Maghreb', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Upper Danube', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ...
     ('Guinea Coast', 27), ('Volta', 27), ('Lower Niger', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Upper Nile', 32), ('Jazira', 32), ('Arabian Peninsula', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Sindh', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Northern Deccan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Gondwana', 32), ('Malwa', 32), ('Rajasthan', 32), ('Doab', 32), ('Bihar', 32), ('Assam', 32), ('Bengal', 32), ('Himalayas', 32), ('Tibetan Plateau', 32), ('Guangxi', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 33), ('Upper Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Chao Phraya', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Moluccas', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Fujian', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Huai He', 33), ('Eastern Siberia', 33), ('East Sea', 33), ('Nippon', 33),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# the Iberian Islands
expeditions_list.append(Expedition('iberian_islands', 'the Iberian Islands', 200, 'Jumping Node', ['Strait of Gibraltar']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 23), ('Alboran Sea', 25), ('Gulf of Lion', 25), ('Bay of Biscay', 25), ('France', 25), ('North Sea', 25), ('Channel', 25), ('Norwegian Sea', 25), ('Western Baltic', 25), ('Berber Coast', 25), ('Maghreb', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Upper Danube', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Dniester', 25), ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 25), ('Eastern Baltic', 25), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Great Steppe', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Anatolia', 25), ('Sahara', 25), ('Senegambia', 26), ('Upper Niger', 26),
     ('Guinea Coast', 27), ('Volta', 27), ('Lower Niger', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Upper Nile', 32), ('Jazira', 32), ('Arabian Peninsula', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Northwest Africa
expeditions_list.append(Expedition('northwest_africa', 'Northwest Africa', 100, 'Jumping Node', ['Strait of Gibraltar']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 23), ('Alboran Sea', 25), ('Gulf of Lion', 25), ('Bay of Biscay', 25), ('France', 25), ('North Sea', 25), ('Channel', 25), ('Norwegian Sea', 25), ('Western Baltic', 25), ('Berber Coast', 25), ('Maghreb', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Upper Danube', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# West Africa
expeditions_list.append(Expedition('west_africa', 'West Africa', 800, 'Jumping Node', ['Senegambia']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 26), ('Strait of Gibraltar', 26), ('Sahara', 26), ('Alboran Sea', 27), ('Gulf of Lion', 27), ('Bay of Biscay', 27), ('France', 27), ('North Sea', 27), ('Channel', 27), ('Norwegian Sea', 27), ('Western Baltic', 27), ('Berber Coast', 27), ('Maghreb', 27), ('Tyrrenean Sea', 27), ('Rhineland', 27), ('Upper Danube', 27), ('Lower Nile', 27), ('Po Valley', 27), ('Adriatic Sea', 27), ('Levantine Sea', 27),
     ...
     ('South Africa', 27), ('Central Africa', 28), ('Monomotapa', 28), ('Somalia', 28), ('Zanj', 28), ('Red Sea', 30), ('Abyssinian Highlands', 30), ('Upper Nile', 30), ('Jazira', 30), ('Arabian Peninsula', 30), ('Arabian Gulf', 30), ('Iran', 30), ('Khorasan', 30), ('Mawarannahr', 30), ('Tarim Basin', 30),
     ...
     ('Western Seaboard', 32), ('Pacific', 43)])
# the Gulf of Guinea
expeditions_list.append(Expedition('gulf_of_guinea', 'the Gulf of Guinea', 800, 'Jumping Node', ['Guinea Coast']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 27), ('Strait of Gibraltar', 27), ('Sahara', 26), ('Alboran Sea', 28), ('Gulf of Lion', 28), ('Bay of Biscay', 28), ('France', 28), ('North Sea', 28), ('Channel', 28), ('Norwegian Sea', 28), ('Western Baltic', 28), ('Berber Coast', 28), ('Maghreb', 28), ('Tyrrenean Sea', 28), ('Rhineland', 28), ('Upper Danube', 28), ('Lower Nile', 28), ('Po Valley', 28), ('Adriatic Sea', 28), ('Levantine Sea', 28),
     ...
     ('South Africa', 27), ('Central Africa', 27), ('Monomotapa', 27), ('Somalia', 27), ('Zanj', 27), ('Red Sea', 30), ('Abyssinian Highlands', 30), ('Upper Nile', 30), ('Jazira', 31), ('Arabian Peninsula', 31), ('Arabian Gulf', 31), ('Iran', 31), ('Khorasan', 31), ('Mawarannahr', 31), ('Tarim Basin', 31),
...
# Central Africa
expeditions_list.append(Expedition('central_africa', 'Central Africa', 800, 'Jumping Node', ['Kongo']))
expeditions_list[-1].set_node_tech_reqs(
    ...
    ('Vistula', 29), ('Black Sea', 29), ('Western Siberia', 29), ('Dnipro', 29), ('Volga', 29), ('Great Steppe', 29), ('Caspian Sea', 29), ('Zalesye', 29), ('Caucasus', 29), ('Anatolia', 29), ('Senegambia', 25), ('Upper Niger', 23), ('Guinea Coast', 23), ('Volta', 23), ('Lower Niger', 23), ('Lake Tchad', 23), ('Kongo', 23), ('South Africa', 25), ('Central Africa', 27), ('Monomotapa', 27),
    ...
    ('Western Seaboard', 32), ('Pacific', 43)])
# South Africa
expeditions_list.append(Expedition('south_africa', 'South Africa', 1200, 'Colonial Node', ['South Africa']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 28), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ...
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 27), ('Volta', 27), ('Lower Niger', 27), ('Lake Tchad', 27), ('Kongo', 25), ('South Africa', 23), ('Central Africa', 25), ('Monomotapa', 25), ('Somalia', 25), ('Zanj', 25), ('Red Sea', 26),
     ...
     ('Western Seaboard', 32), ('Pacific', 43)])
# East Africa
expeditions_list.append(Expedition('east_africa', 'East Africa', 800, 'Jumping Node', ['Zanj', 'Somalia']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 28), ('Upper Niger', 28), ('Guinea Coast', 27), ('Volta', 28), ('Lower Niger', 28), ('Lake Tchad', 28), ('Kongo', 27), ('South Africa', 25), ('Central Africa', 23), ('Monomotapa', 23), ('Somalia', 23), ('Zanj', 23), ('Red Sea', 23),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# the Indian Ocean
expeditions_list.append(Expedition('indian_ocean', 'the Indian Ocean', 800, 'Jumping Node', ['Zanj']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 28), ('Upper Niger', 28), ('Guinea Coast', 27), ('Volta', 28), ('Lower Niger', 28), ('Lake Tchad', 28), ('Kongo', 27), ('South Africa', 25), ('Central Africa', 23), ('Monomotapa', 23), ('Somalia', 23), ('Zanj', 23), ('Red Sea', 25),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Arabian Gulf
expeditions_list.append(Expedition('arabia', 'Arabia', 400, 'Jumping Node', ['Red Sea', 'Arabian Gulf']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 26), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 27), ('Central Africa', 26), ('Monomotapa', 26), ('Somalia', 25), ('Zanj', 25), ('Red Sea', 23),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Western India
expeditions_list.append(Expedition('western_india', 'Western India', 1200, 'Jumping Node', ['Gurjaratra', 'Konkan']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 28), ('Central Africa', 27), ('Monomotapa', 27), ('Somalia', 27), ('Zanj', 27), ('Red Sea', 25),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Southern India
expeditions_list.append(Expedition('southern_india', 'Southern India', 1200, 'Jumping Node', ['Konkan', 'Tamilakam']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 28), ('Central Africa', 27), ('Monomotapa', 27), ('Somalia', 27), ('Zanj', 27), ('Red Sea', 25),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Eastern India
expeditions_list.append(Expedition('eastern_india', 'Eastern India', 1200, 'Jumping Node', ['Kalinga', 'Bengal']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 28), ('Central Africa', 27), ('Monomotapa', 27), ('Somalia', 27), ('Zanj', 27), ('Red Sea', 26),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Malacca
expeditions_list.append(Expedition('malacca', 'Malacca', 800, 'Regular', ['Malacca Strait']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Alboran Sea', 31), ('Gulf of Lion', 31), ('Bay of Biscay', 31), ('France', 31), ('North Sea', 31), ('Channel', 31), ('Norwegian Sea', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Maghreb', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Upper Danube', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ...
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Great Steppe', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Anatolia', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Volta', 31), ('Lower Niger', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 27),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Southeast Asia
expeditions_list.append(Expedition('southeast_asia', 'Southeast Asia', 600, 'Regular', ['Lower Ayeyarwady', 'Chao Phraya', 'Champa Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Alboran Sea', 31), ('Gulf of Lion', 31), ('Bay of Biscay', 31), ('France', 31), ('North Sea', 31), ('Channel', 31), ('Norwegian Sea', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Maghreb', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Upper Danube', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ('Aegean Sea', 31), ('Dniester', 31), ('Lower Danube', 31), ('Middle Danube', 31), ('Elbe', 31), ('Eastern Baltic', 31),
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Great Steppe', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Anatolia', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Volta', 31), ('Lower Niger', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 27),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Indonesia
expeditions_list.append(Expedition('indonesia', 'Indonesia', 1200, 'Regular', ['Sunda Strait', 'Moluccas']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Alboran Sea', 31), ('Gulf of Lion', 31), ('Bay of Biscay', 31), ('France', 31), ('North Sea', 31), ('Channel', 31), ('Norwegian Sea', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Maghreb', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Upper Danube', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ('Aegean Sea', 31), ('Dniester', 31), ('Lower Danube', 31), ('Middle Danube', 31), ('Elbe', 31), ('Eastern Baltic', 31),
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Great Steppe', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Anatolia', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Volta', 31), ('Lower Niger', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 27),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# the Philippines
expeditions_list.append(Expedition('philippines', 'the Philippines', 800, 'Regular', ['Moluccas']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Alboran Sea', 31), ('Gulf of Lion', 31), ('Bay of Biscay', 31), ('France', 31), ('North Sea', 31), ('Channel', 31), ('Norwegian Sea', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Maghreb', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Upper Danube', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ('Aegean Sea', 31), ('Dniester', 31), ('Lower Danube', 31), ('Middle Danube', 31), ('Elbe', 31), ('Eastern Baltic', 31),
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Great Steppe', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Anatolia', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Volta', 31), ('Lower Niger', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 27),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Papua New Guinea
expeditions_list.append(Expedition('papua', 'Papua New Guinea', 100, 'Regular', ['Moluccas', 'Australia']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 49), ('Strait of Gibraltar', 49), ('Sahara', 49), ('Alboran Sea', 49), ('Gulf of Lion', 49), ('Bay of Biscay', 49), ('France', 49), ('North Sea', 49), ('Channel', 49), ('Norwegian Sea', 49), ('Western Baltic', 49), ('Berber Coast', 49), ('Maghreb', 49), ('Tyrrenean Sea', 49), ('Rhineland', 49), ('Upper Danube', 49), ('Lower Nile', 49), ('Po Valley', 49), ('Adriatic Sea', 49), ('Levantine Sea', 49),
     ...
     ('Vistula', 49), ('Black Sea', 49), ('Western Siberia', 49), ('Dnipro', 49), ('Volga', 49), ('Great Steppe', 49), ('Caspian Sea', 49), ('Zalesye', 49), ('Caucasus', 49), ('Anatolia', 49), ('Senegambia', 49), ('Upper Niger', 49), ('Guinea Coast', 49), ('Volta', 49), ('Lower Niger', 49), ('Lake Tchad', 49), ('Kongo', 49), ('South Africa', 49), ('Central Africa', 49), ('Monomotapa', 49), ('Somalia', 49), ('Zanj', 49), ('Red Sea', 49),
     ...
     ('Western Seaboard', 49), ('Pacific', 49)])
# Australia
expeditions_list.append(Expedition('australia', 'Australia', 100, 'Colonial Node', ['Australia']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 48), ('Strait of Gibraltar', 48), ('Sahara', 48), ('Alboran Sea', 48), ('Gulf of Lion', 48), ('Bay of Biscay', 48), ('France', 48), ('North Sea', 48), ('Channel', 48), ('Norwegian Sea', 48), ('Western Baltic', 48), ('Berber Coast', 48), ('Maghreb', 48), ('Tyrrenean Sea', 48), ('Rhineland', 48), ('Upper Danube', 48), ('Lower Nile', 48), ('Po Valley', 48), ('Adriatic Sea', 48), ('Levantine Sea', 48),
     ...
     ('Vistula', 48), ('Black Sea', 48), ('Western Siberia', 48), ('Dnipro', 48), ('Volga', 48), ('Great Steppe', 48), ('Caspian Sea', 48), ('Zalesye', 48), ('Caucasus', 48), ('Anatolia', 48), ('Senegambia', 48), ('Upper Niger', 48), ('Guinea Coast', 48), ('Volta', 48), ('Lower Niger', 48), ('Lake Tchad', 48), ('Kongo', 48), ('South Africa', 48), ('Central Africa', 48), ('Monomotapa', 48), ('Somalia', 48), ('Zanj', 48), ('Red Sea', 48),
     ...
     ('Western Seaboard', 48), ('Pacific', 43)])
# the Pacific Islands
expeditions_list.append(Expedition('pacific_islands', 'the Pacific Islands', 400, 'Jumping Node', ['Australia', 'Pacific']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 43), ('Strait of Gibraltar', 43), ('Sahara', 43), ('Alboran Sea', 43), ('Gulf of Lion', 43), ('Bay of Biscay', 43), ('France', 43), ('North Sea', 43), ('Channel', 43), ('Norwegian Sea', 43), ('Western Baltic', 43), ('Berber Coast', 43), ('Maghreb', 43), ('Tyrrenean Sea', 43), ('Rhineland', 43), ('Upper Danube', 43), ('Lower Nile', 43), ('Po Valley', 43), ('Adriatic Sea', 43), ('Levantine Sea', 43),
     ...
     ('Vistula', 43), ('Black Sea', 43), ('Western Siberia', 43), ('Dnipro', 43), ('Volga', 43), ('Great Steppe', 43), ('Caspian Sea', 43), ('Zalesye', 43), ('Caucasus', 43), ('Anatolia', 43), ('Senegambia', 43), ('Upper Niger', 43), ('Guinea Coast', 43), ('Volta', 43), ('Lower Niger', 43), ('Lake Tchad', 43), ('Kongo', 43), ('South Africa', 43), ('Central Africa', 43), ('Monomotapa', 43), ('Somalia', 43), ('Zanj', 43), ('Red Sea', 43),
     ...
     ('Western Seaboard', 43), ('Pacific', 43)])
# Southern China
expeditions_list.append(Expedition('southern_china', 'Southern China', 800, 'Chinese Mainland', ['Liangguang', 'Fujian', 'Jiangnan']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Alboran Sea', 32), ('Gulf of Lion', 32), ('Bay of Biscay', 32), ('France', 32), ('North Sea', 32), ('Channel', 32), ('Norwegian Sea', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Maghreb', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Upper Danube', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ...
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Great Steppe', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Anatolia', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Volta', 32), ('Lower Niger', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 29),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Northern China
expeditions_list.append(Expedition('northern_china', 'Northern China', 800, 'Chinese Mainland', ['Zhongyuan', 'Huabei', 'Yellow Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Alboran Sea', 32), ('Gulf of Lion', 32), ('Bay of Biscay', 32), ('France', 32), ('North Sea', 32), ('Channel', 32), ('Norwegian Sea', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Maghreb', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Upper Danube', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ('Aegean Sea', 32), ('Dniester', 32), ('Lower Danube', 32), ('Middle Danube', 32), ('Elbe', 32), ('Eastern Baltic', 32),
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Great Steppe', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Anatolia', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Volta', 32), ('Lower Niger', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 29),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Korea
expeditions_list.append(Expedition('korea', 'Korea', 400, 'Chinese Mainland', ['Yellow Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Alboran Sea', 32), ('Gulf of Lion', 32), ('Bay of Biscay', 32), ('France', 32), ('North Sea', 32), ('Channel', 32), ('Norwegian Sea', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Maghreb', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Upper Danube', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ('Aegean Sea', 32), ('Dniester', 32), ('Lower Danube', 32), ('Middle Danube', 32), ('Elbe', 32), ('Eastern Baltic', 32),
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Great Steppe', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Anatolia', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Volta', 32), ('Lower Niger', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 30),
     ...
     ('Western Seaboard', 33), ('Pacific', 43)])
# Japan
expeditions_list.append(Expedition('japan', 'Japan', 400, 'Jumping Node', ['Nippon', 'East Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Alboran Sea', 32), ('Gulf of Lion', 32), ('Bay of Biscay', 32), ('France', 32), ('North Sea', 32), ('Channel', 32), ('Norwegian Sea', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Maghreb', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Upper Danube', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ('Aegean Sea', 32), ('Dniester', 32), ('Lower Danube', 32), ('Middle Danube', 32), ('Elbe', 32), ('Eastern Baltic', 32),
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Great Steppe', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Anatolia', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Volta', 32), ('Lower Niger', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 30),
...
# Cuba
expeditions_list.append(Expedition('cuba', 'Cuba', 800, 'Colonial Node', ['Caribbean']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 29), ('Strait of Gibraltar', 29), ('Sahara', 29), ('Alboran Sea', 29), ('Gulf of Lion', 29), ('Bay of Biscay', 29), ('France', 29), ('North Sea', 29), ('Channel', 29), ('Norwegian Sea', 29), ('Western Baltic', 29), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 32), ('Great Steppe', 32), ('Caspian Sea', 32), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 29), ('Upper Niger', 29), ('Guinea Coast', 29), ('Volta', 29), ('Lower Niger', 29), ('Lake Tchad', 29), ('Kongo', 29), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 31),
     ...
     ('Western Seaboard', 30), ('Pacific', 43)])
# Hispaniola
expeditions_list.append(Expedition('hispaniola', 'Hispaniola', 800, 'Colonial Node', ['Caribbean']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 29), ('Strait of Gibraltar', 29), ('Sahara', 29), ('Alboran Sea', 29), ('Gulf of Lion', 29), ('Bay of Biscay', 29), ('France', 29), ('North Sea', 29), ('Channel', 29), ('Norwegian Sea', 29), ('Western Baltic', 29), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 29), ('Upper Niger', 29), ('Guinea Coast', 29), ('Volta', 29), ('Lower Niger', 29), ('Lake Tchad', 29), ('Kongo', 29), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 31),
     ('Abyssinian Highlands', 31), ('Upper Nile', 31), ('Jazira', 32), ('Arabian Peninsula', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Sindh', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Northern Deccan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Gondwana', 32), ('Malwa', 32), ('Rajasthan', 32), ('Doab', 32), ('Bihar', 32), ('Assam', 32), ('Bengal', 32), ('Himalayas', 32), ('Tibetan Plateau', 32), ('Guangxi', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 32), ('Upper Ayeyarwady', 32), ('Malacca Strait', 32), ('Mekong', 32), ('Chao Phraya', 32), ('Sunda Strait', 32),
     ('Champa Sea', 32), ('Moluccas', 32), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Fujian', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Huai He', 32), ('Eastern Siberia', 32), ('East Sea', 32), ('Nippon', 32),
     ('Yellow Sea', 32), ('Amur', 32), ('Chala', 29), ('Southern Andes', 29), ('Central Andes', 29), ('Southern Cone', 27), ('Guiana', 26), ('Northern Andes', 26), ('Amazonia', 29), ('Cerrado', 29), ('Isthmus of Darien', 25), ('Caribbean', 23), ('Valley of Mexico', 25), ('Western Valley', 25), ('Gulf of Mexico', 25), ('Gulf of Tehuantepec', 25), ('Rio Grande', 25), ('Mississippi', 25), ('Western Cordillera', 25), ('Plains', 25), ('Eastern Seaboard', 25), ('Great Lakes', 27),
     ('Western Seaboard', 30), ('Pacific', 43)])
# Caribbean
expeditions_list.append(Expedition('caribbean', 'Caribbean', 800, 'Jumping Node', ['Caribbean']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 29), ('Strait of Gibraltar', 29), ('Sahara', 29), ('Alboran Sea', 29), ('Gulf of Lion', 29), ('Bay of Biscay', 29), ('France', 29), ('North Sea', 29), ('Channel', 29), ('Norwegian Sea', 29), ('Western Baltic', 29), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 29), ('Upper Niger', 29), ('Guinea Coast', 29), ('Volta', 29), ('Lower Niger', 29), ('Lake Tchad', 29), ('Kongo', 29), ('South Africa', 30), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 31),
     ...
     ('Western Seaboard', 30), ('Pacific', 43)])
# Atlantic Colombia
expeditions_list.append(Expedition('atlantic_colombia', 'Atlantic Colombia', 300, 'Colonial Node', ['Northern Andes']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 33),
     ...
     ('Western Seaboard', 30), ('Pacific', 43)])
# Guyana
expeditions_list.append(Expedition('guyana', 'Guyana', 200, 'Colonial Node', ['Guiana']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 33),
     ...
     ('Western Seaboard', 30), ('Pacific', 43)])
# Atlantic Mexico
expeditions_list.append(Expedition('atlantic_mexico', 'Atlantic Mexico', 1600, 'Colonial Node', ['Gulf of Mexico', 'Isthmus of Darien']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Alboran Sea', 31), ('Gulf of Lion', 31), ('Bay of Biscay', 31), ('France', 31), ('North Sea', 31), ('Channel', 31), ('Norwegian Sea', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Maghreb', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Upper Danube', 31), ('Lower Nile', 31), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ('Aegean Sea', 31), ('Dniester', 31), ('Lower Danube', 31), ('Middle Danube', 31), ('Elbe', 31), ('Eastern Baltic', 31),
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Great Steppe', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Anatolia', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Volta', 31), ('Lower Niger', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 31), ('Central Africa', 31), ('Monomotapa', 31), ('Somalia', 31), ('Zanj', 31), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Upper Nile', 33), ('Jazira', 33), ('Arabian Peninsula', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Sindh', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Northern Deccan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Gondwana', 33), ('Malwa', 33), ('Rajasthan', 33), ('Doab', 33), ('Bihar', 33), ('Assam', 33), ('Bengal', 33), ('Himalayas', 33), ('Tibetan Plateau', 33), ('Guangxi', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Upper Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Chao Phraya', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Moluccas', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Fujian', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Huai He', 33), ('Eastern Siberia', 33), ('East Sea', 33), ('Nippon', 33),
     ...
     ('Western Seaboard', 30), ('Pacific', 43)])
# Northern Brazil
expeditions_list.append(Expedition('north_brazil', 'Northern Brazil', 600, 'Colonial Node', ['Guiana']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 27), ('Volta', 27), ('Lower Niger', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 29), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 30),
     ...
     ('Western Seaboard', 29), ('Pacific', 43)])
# Southern Brazil
expeditions_list.append(Expedition('south_brazil', 'Southern Brazil', 600, 'Colonial Node', ['Southern Cone']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Alboran Sea', 30), ('Gulf of Lion', 30), ('Bay of Biscay', 30), ('France', 30), ('North Sea', 30), ('Channel', 30), ('Norwegian Sea', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Maghreb', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Upper Danube', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Dniester', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Great Steppe', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Anatolia', 30), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 27), ('Volta', 27), ('Lower Niger', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 29), ('Central Africa', 30), ('Monomotapa', 30), ('Somalia', 30), ('Zanj', 30), ('Red Sea', 30),
     ...
     ('Western Seaboard', 29), ('Pacific', 43)])
# the Gulf of Mexico
expeditions_list.append(Expedition('gulf_of_mexico', 'the Gulf of Mexico', 200, 'Colonial Node', ['Rio Grande', 'Mississippi']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('Alboran Sea', 35), ('Gulf of Lion', 35), ('Bay of Biscay', 35), ('France', 35), ('North Sea', 35), ('Channel', 35), ('Norwegian Sea', 35), ('Western Baltic', 35), ('Berber Coast', 35), ('Maghreb', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Upper Danube', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levantine Sea', 35),
     ...
     ('Vistula', 35), ('Black Sea', 35), ('Western Siberia', 35), ('Dnipro', 35), ('Volga', 35), ('Great Steppe', 35), ('Caspian Sea', 35), ('Zalesye', 35), ('Caucasus', 35), ('Anatolia', 35), ('Senegambia', 35), ('Upper Niger', 35), ('Guinea Coast', 35), ('Volta', 35), ('Lower Niger', 35), ('Lake Tchad', 35), ('Kongo', 35), ('South Africa', 35), ('Central Africa', 35), ('Monomotapa', 35), ('Somalia', 35), ('Zanj', 35), ('Red Sea', 35),
...
expeditions_list.append(Expedition('southeastern_america', 'Southeastern America', 400, 'Colonial Node', ['Caribbean', 'Eastern Seaboard']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Alboran Sea', 33), ('Gulf of Lion', 33), ('Bay of Biscay', 33), ('France', 33), ('North Sea', 33), ('Channel', 33), ('Norwegian Sea', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Maghreb', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Upper Danube', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ...
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Great Steppe', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Anatolia', 33), ('Senegambia', 33), ('Upper Niger', 33), ('Guinea Coast', 33), ('Volta', 33), ('Lower Niger', 33), ('Lake Tchad', 33), ('Kongo', 33), ('South Africa', 33), ('Central Africa', 33), ('Monomotapa', 33), ('Somalia', 33), ('Zanj', 33), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Upper Nile', 33), ('Jazira', 33), ('Arabian Peninsula', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Sindh', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Northern Deccan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Gondwana', 33), ('Malwa', 33), ('Rajasthan', 33), ('Doab', 33), ('Bihar', 33), ('Assam', 33), ('Bengal', 33), ('Himalayas', 33), ('Tibetan Plateau', 33), ('Guangxi', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Upper Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Chao Phraya', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Moluccas', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Fujian', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Huai He', 33), ('Eastern Siberia', 33), ('East Sea', 33), ('Nippon', 33),
     ...
     ('Western Seaboard', 30), ('Pacific', 43)])
# Eastern America
expeditions_list.append(Expedition('eastern_america', 'Eastern America', 400, 'Colonial Node', ['Eastern Seaboard']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('Alboran Sea', 35), ('Gulf of Lion', 35), ('Bay of Biscay', 35), ('France', 35), ('North Sea', 35), ('Channel', 35), ('Norwegian Sea', 35), ('Western Baltic', 35), ('Berber Coast', 35), ('Maghreb', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Upper Danube', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levantine Sea', 35),
     ('Aegean Sea', 35), ('Dniester', 35), ('Lower Danube', 35), ('Middle Danube', 35), ('Elbe', 35), ('Eastern Baltic', 35),
     ('Vistula', 35), ('Black Sea', 35), ('Western Siberia', 35), ('Dnipro', 35), ('Volga', 35), ('Great Steppe', 35), ('Caspian Sea', 35), ('Zalesye', 35), ('Caucasus', 35), ('Anatolia', 35), ('Senegambia', 35), ('Upper Niger', 35), ('Guinea Coast', 35), ('Volta', 35), ('Lower Niger', 35), ('Lake Tchad', 35), ('Kongo', 35), ('South Africa', 35), ('Central Africa', 35), ('Monomotapa', 35), ('Somalia', 35), ('Zanj', 35), ('Red Sea', 35),
     ...
     ('Western Seaboard', 31), ('Pacific', 43)])
# Canada
expeditions_list.append(Expedition('canada', 'Canada', 200, 'Colonial Node', ['Eastern Seaboard']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('Alboran Sea', 35), ('Gulf of Lion', 35), ('Bay of Biscay', 35), ('France', 35), ('North Sea', 35), ('Channel', 35), ('Norwegian Sea', 35), ('Western Baltic', 35), ('Berber Coast', 35), ('Maghreb', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Upper Danube', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levantine Sea', 35),
     ('Aegean Sea', 35), ('Dniester', 35), ('Lower Danube', 35), ('Middle Danube', 35), ('Elbe', 35), ('Eastern Baltic', 35),
     ('Vistula', 35), ('Black Sea', 35), ('Western Siberia', 35), ('Dnipro', 35), ('Volga', 35), ('Great Steppe', 35), ('Caspian Sea', 35), ('Zalesye', 35), ('Caucasus', 35), ('Anatolia', 35), ('Senegambia', 35), ('Upper Niger', 35), ('Guinea Coast', 35), ('Volta', 35), ('Lower Niger', 35), ('Lake Tchad', 35), ('Kongo', 35), ('South Africa', 35), ('Central Africa', 35), ('Monomotapa', 35), ('Somalia', 35), ('Zanj', 35), ('Red Sea', 35),
     ...
     ('Western Seaboard', 35), ('Pacific', 43)])
# the North Atlantic
expeditions_list.append(Expedition('north_atlantic', 'the North Atlantic', 50, 'Jumping Node', ['Norwegian Sea']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 40), ('Strait of Gibraltar', 40), ('Sahara', 40), ('Alboran Sea', 40), ('Gulf of Lion', 40), ('Bay of Biscay', 40), ('France', 40), ('North Sea', 40), ('Channel', 40), ('Norwegian Sea', 40), ('Western Baltic', 40), ('Berber Coast', 40), ('Maghreb', 40), ('Tyrrenean Sea', 40), ('Rhineland', 40), ('Upper Danube', 40), ('Lower Nile', 40), ('Po Valley', 40), ('Adriatic Sea', 40), ('Levantine Sea', 40),
     ...
     ('Vistula', 40), ('Black Sea', 40), ('Western Siberia', 40), ('Dnipro', 40), ('Volga', 40), ('Great Steppe', 40), ('Caspian Sea', 40), ('Zalesye', 40), ('Caucasus', 40), ('Anatolia', 40), ('Senegambia', 40), ('Upper Niger', 40), ('Guinea Coast', 40), ('Volta', 40), ('Lower Niger', 40), ('Lake Tchad', 40), ('Kongo', 40), ('South Africa', 40), ('Central Africa', 40), ('Monomotapa', 40), ('Somalia', 40), ('Zanj', 40), ('Red Sea', 40),
     ...
     ('Western Seaboard', 40), ('Pacific', 43)])
# Hudson Bay
expeditions_list.append(Expedition('hudson_bay', 'Hudson Bay', 100, 'Colonial Node', ['Great Lakes']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 45), ('Strait of Gibraltar', 45), ('Sahara', 45), ('Alboran Sea', 45), ('Gulf of Lion', 45), ('Bay of Biscay', 45), ('France', 45), ('North Sea', 45), ('Channel', 45), ('Norwegian Sea', 45), ('Western Baltic', 45), ('Berber Coast', 45), ('Maghreb', 45), ('Tyrrenean Sea', 45), ('Rhineland', 45), ('Upper Danube', 45), ('Lower Nile', 45), ('Po Valley', 45), ('Adriatic Sea', 45), ('Levantine Sea', 45),
     ...
     ('Vistula', 45), ('Black Sea', 45), ('Western Siberia', 45), ('Dnipro', 45), ('Volga', 45), ('Great Steppe', 45), ('Caspian Sea', 45), ('Zalesye', 45), ('Caucasus', 45), ('Anatolia', 45), ('Senegambia', 45), ('Upper Niger', 45), ('Guinea Coast', 45), ('Volta', 45), ('Lower Niger', 45), ('Lake Tchad', 45), ('Kongo', 45), ('South Africa', 45), ('Central Africa', 45), ('Monomotapa', 45), ('Somalia', 45), ('Zanj', 45), ('Red Sea', 45),
     ...
     ('Western Seaboard', 45), ('Pacific', 45)])
# Southern Cone
expeditions_list.append(Expedition('la_plata', 'Southern Cone', 100, 'Colonial Node', ['Southern Cone']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Alboran Sea', 33), ('Gulf of Lion', 33), ('Bay of Biscay', 33), ('France', 33), ('North Sea', 33), ('Channel', 33), ('Norwegian Sea', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Maghreb', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Upper Danube', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Dniester', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33),
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Great Steppe', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Anatolia', 33), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Volta', 30), ('Lower Niger', 30), ('Lake Tchad', 30), ('Kongo', 31), ('South Africa', 33), ('Central Africa', 33), ('Monomotapa', 33), ('Somalia', 33), ('Zanj', 33), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Upper Nile', 33), ('Jazira', 33), ('Arabian Peninsula', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Sindh', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Northern Deccan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Gondwana', 33), ('Malwa', 33), ('Rajasthan', 33), ('Doab', 33), ('Bihar', 33), ('Assam', 33), ('Bengal', 33), ('Himalayas', 33), ('Tibetan Plateau', 33), ('Guangxi', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Upper Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Chao Phraya', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Moluccas', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Fujian', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Huai He', 33), ('Eastern Siberia', 33), ('East Sea', 33), ('Nippon', 33),
     ...
     ('Western Seaboard', 29), ('Pacific', 43)])
# California
expeditions_list.append(Expedition('california', 'California', 100, 'Colonial Node', ['Western Seaboard']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 40), ('Strait of Gibraltar', 40), ('Sahara', 40), ('Alboran Sea', 40), ('Gulf of Lion', 40), ('Bay of Biscay', 40), ('France', 40), ('North Sea', 40), ('Channel', 40), ('Norwegian Sea', 40), ('Western Baltic', 40), ('Berber Coast', 40), ('Maghreb', 40), ('Tyrrenean Sea', 40), ('Rhineland', 40), ('Upper Danube', 40), ('Lower Nile', 40), ('Po Valley', 40), ('Adriatic Sea', 40), ('Levantine Sea', 40),
     ('Aegean Sea', 40), ('Dniester', 40), ('Lower Danube', 40), ('Middle Danube', 40), ('Elbe', 40), ('Eastern Baltic', 40),
     ('Vistula', 40), ('Black Sea', 40), ('Western Siberia', 40), ('Dnipro', 40), ('Volga', 40), ('Great Steppe', 40), ('Caspian Sea', 40), ('Zalesye', 40), ('Caucasus', 40), ('Anatolia', 40), ('Senegambia', 40), ('Upper Niger', 40), ('Guinea Coast', 40), ('Volta', 40), ('Lower Niger', 40), ('Lake Tchad', 40), ('Kongo', 40), ('South Africa', 40), ('Central Africa', 40), ('Monomotapa', 40), ('Somalia', 40), ('Zanj', 40), ('Red Sea', 35),
     ('Abyssinian Highlands', 35), ('Upper Nile', 35), ('Jazira', 35), ('Arabian Peninsula', 35), ('Arabian Gulf', 35), ('Iran', 35), ('Khorasan', 35), ('Mawarannahr', 35), ('Tarim Basin', 35),
     ...
     ('Western Seaboard', 23), ('Pacific', 43)])
# Alaska
expeditions_list.append(Expedition('alaska', 'Alaska', 100, 'Colonial Node', ['Western Seaboard']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 47), ('Strait of Gibraltar', 47), ('Sahara', 47), ('Alboran Sea', 47), ('Gulf of Lion', 47), ('Bay of Biscay', 47), ('France', 47), ('North Sea', 47), ('Channel', 47), ('Norwegian Sea', 47), ('Western Baltic', 47), ('Berber Coast', 47), ('Maghreb', 47), ('Tyrrenean Sea', 47), ('Rhineland', 47), ('Upper Danube', 47), ('Lower Nile', 47), ('Po Valley', 47), ('Adriatic Sea', 47), ('Levantine Sea', 47),
     ...
     ('Vistula', 47), ('Black Sea', 47), ('Western Siberia', 47), ('Dnipro', 47), ('Volga', 47), ('Great Steppe', 47), ('Caspian Sea', 47), ('Zalesye', 47), ('Caucasus', 47), ('Anatolia', 47), ('Senegambia', 47), ('Upper Niger', 47), ('Guinea Coast', 47), ('Volta', 47), ('Lower Niger', 47), ('Lake Tchad', 47), ('Kongo', 47), ('South Africa', 47), ('Central Africa', 47), ('Monomotapa', 47), ('Somalia', 47), ('Zanj', 47), ('Red Sea', 47),
     ...
     ('Western Seaboard', 23), ('Pacific', 43)])
# Pacific Mexico
expeditions_list.append(Expedition('pacific_mexico', 'Pacific Mexico', 800, 'Colonial Node', ['Western Valley', 'Gulf of Tehuantepec']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Alboran Sea', 33), ('Gulf of Lion', 33), ('Bay of Biscay', 33), ('France', 33), ('North Sea', 33), ('Channel', 33), ('Norwegian Sea', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Maghreb', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Upper Danube', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ...
     ('South Africa', 33), ('Central Africa', 33), ('Monomotapa', 33), ('Somalia', 33), ('Zanj', 33), ('Red Sea', 33), ('Abyssinian Highlands', 33), ('Upper Nile', 33), ('Jazira', 33), ('Arabian Peninsula', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Sindh', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Northern Deccan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Gondwana', 33), ('Malwa', 33), ('Rajasthan', 33), ('Doab', 33), ('Bihar', 33), ('Assam', 33), ('Bengal', 33), ('Himalayas', 33), ('Tibetan Plateau', 33), ('Guangxi', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Upper Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Chao Phraya', 33), ('Sunda Strait', 33),
     ...
     ('Western Seaboard', 25), ('Pacific', 43)])
# Pacific Central America
expeditions_list.append(Expedition('pacific_central_america', 'Pacific Central America', 1200, 'Colonial Node', ['Gulf of Tehuantepec', 'Isthmus of Darien', 'Northern Andes']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Alboran Sea', 33), ('Gulf of Lion', 33), ('Bay of Biscay', 33), ('France', 33), ('North Sea', 33), ('Channel', 33), ('Norwegian Sea', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Maghreb', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Upper Danube', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Dniester', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33),
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Great Steppe', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Anatolia', 33), ('Senegambia', 33), ('Upper Niger', 33), ('Guinea Coast', 33), ('Volta', 33), ('Lower Niger', 33), ('Lake Tchad', 33), ('Kongo', 33), ('South Africa', 33), ('Central Africa', 33), ('Monomotapa', 33), ('Somalia', 33), ('Zanj', 33), ('Red Sea', 33),
     ...
     ('Western Seaboard', 26), ('Pacific', 43)])
# Peru
expeditions_list.append(Expedition('peru', 'Peru', 2400, 'Colonial Node', ['Chala']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Alboran Sea', 33), ('Gulf of Lion', 33), ('Bay of Biscay', 33), ('France', 33), ('North Sea', 33), ('Channel', 33), ('Norwegian Sea', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Maghreb', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Upper Danube', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Dniester', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33),
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Great Steppe', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Anatolia', 33), ('Senegambia', 33), ('Upper Niger', 33), ('Guinea Coast', 33), ('Volta', 33), ('Lower Niger', 33), ('Lake Tchad', 33), ('Kongo', 33), ('South Africa', 33), ('Central Africa', 33), ('Monomotapa', 33), ('Somalia', 33), ('Zanj', 33), ('Red Sea', 33),
     ...
     ('Western Seaboard', 27), ('Pacific', 43)])
# Chile
expeditions_list.append(Expedition('chile', 'Chile', 400, 'Colonial Node', ['Southern Andes']))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Alboran Sea', 33), ('Gulf of Lion', 33), ('Bay of Biscay', 33), ('France', 33), ('North Sea', 33), ('Channel', 33), ('Norwegian Sea', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Maghreb', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Upper Danube', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Dniester', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33),
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Great Steppe', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Anatolia', 33), ('Senegambia', 33), ('Upper Niger', 33), ('Guinea Coast',33), ('Volta', 33), ('Lower Niger', 33), ('Lake Tchad', 33), ('Kongo', 33), ('South Africa', 33), ('Central Africa', 33), ('Monomotapa', 33), ('Somalia', 33), ('Zanj', 33), ('Red Sea', 33),
...
select_expedition_option_frame_bottom = """\
			...
			modifier = {{ # Stop AI from loosing expeditions of provinces owned by comparable nations
				...
				expedition_provs.{expedition_name} = {{
					type = all 
					is_empty = no
					owner = {{ check_variable = {{ lhs = tech_mil which = ROOT }} }}
				}}
			}}
		}}
		hidden_effect = {{
		...
		hidden_effect = {{
			...
			event_target:MEC_Expedition_Target_Province = {{ # FROM is the province, ROOT is the expedition sender
				...
				if = {{ # Change religion and culture if empty province not in trade company or in trade company with no population
					...
					ROOT = {{
						capital_scope = {{
							event_target:MEC_Expedition_Target_Province = {{ set_variable = {{ lhs = Plague_Resistance1 which = PREV }} }}
							event_target:MEC_Expedition_Target_Province = {{ set_variable = {{ lhs = Plague_Resistance2 which = PREV }} }}
							event_target:MEC_Expedition_Target_Province = {{ set_variable = {{ lhs = Plague_Resistance4 which = PREV }} }}
						    
						    event_target:MEC_Expedition_Target_Province = {{ divide_variable = {{ lhs = Plague_Resistance1 value = 3 }} }}
						    event_target:MEC_Expedition_Target_Province = {{ divide_variable = {{ lhs = Plague_Resistance2 value = 3 }} }}
						    event_target:MEC_Expedition_Target_Province = {{ divide_variable = {{ lhs = Plague_Resistance4 value = 3 }} }}
						}}
						
                        if = {{
                            limit = {{
                                any_owned_province = {{
                                    check_variable = {{ lhs = Plague_SpawnChance4 value = 0.1 }}
                                }}
                            }}                        
                            ...
                            if = {{
                                ...
                                if = {{
                                    ...
                                    every_neighbor_province = {{
                                        limit = {{
                                            NOT = {{
                                                check_variable = {{ lhs = Plague_SpawnChance2 value = 0.1 }}
                                                check_variable = {{ lhs = Plague_Resistance2 value = 0.1 }}
                                            }}
                                            owner = {{
                                                OR = {{
...
with open(Path('events/MEC-Expeditions.txt'), 'w', encoding='cp1252') as events:
    with open(Path('localisation/MEC-Expeditions_l_english.yml'), 'w', encoding='utf-8-sig') as loc:
        ...
        for index, expedition in enumerate(expeditions_list):
            ...
            for i, node_name in enumerate(expedition.associated_TN):
                node_number = trade_nodes[node_name]
