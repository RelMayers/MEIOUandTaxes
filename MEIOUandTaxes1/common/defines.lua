...
NDiplomacy = {
	...
	PREPARE_FOR_WAR_COST = 1000,  -- Cost in favors to ask AI to prepare for war
	PREPARE_FOR_WAR_MONTHS = 12,					-- Number of months AI will prepare for war
	CALL_TO_ARMS_COST = 1000,							-- Cost in favors to call ally to arms when you're not promising them territory
	...
	OVEREXTENSION_THRESHOLD = 5.0,  -- at which threshold you can get events
	...
	IMPERIAL_REFORM_COST = 90,						-- Minium Cost of enacting a new reform.
	...
	PEACE_COST_GOLD_MAX = 1,  -- Maximum loans of gold that can be demanded from giver in peace.
	...
	MAX_PEACE_COST_TRIBUTARY_STATE = 1000,  
	...
	STUDY_TECHNOLOGY_MIN_TECHS_AHEAD = 200,			-- Target must be at least this number of techs ahead of you to get power
...
NCountry = {
	...
	MAXIMUM_CONDOTTIERI = 100,  -- FROM 20 => meant to disable condotierri -- Base number of units you can rent out
	...
	BASE_FREE_POLICIES = 3,							-- How many policies in a category a nation get for free
	...
	PS_HARSH_TREATMENT_COST = 9999,  -- Max cost for harsh treatment (scales to revolt size)
	...
	ABANDON_IDEAGROUP_REFUND = 0,				-- The part of the idea group spent that will be refunded upon abandonment.
	...
	OVEREXTENSION_FACTOR = 0.05,  
	OVEREXTENSION_OVERSEAS_FACTOR = 0.05,  -- Modifier to overextension from overseas provinces
	...
	MIN_HARSH_TREATMENT_COST = 8888, -- Minimum harsh treatment cost
...
NAI = {
	...
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 10000, --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
	...
	AGGRESSIVENESS_BONUS_EASY_WAR = 1500,  -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	...
	DANGEROUS_OVEREXTENSION_PERCENTAGE = 0.01,
	...
	PEACE_WAR_EXHAUSTION_FACTOR = 2.0,  
	PEACE_HIGH_WAR_EXHAUSTION_THRESHOLD = 10, -- Threshold for when PEACE_HIGH_WAR_EXHAUSTION_FACTOR is applied
	PEACE_HIGH_WAR_EXHAUSTION_FACTOR = 4.0, -- Additional AI willingness to peace based on war exhaustion above the high threshold
	...
	PEACE_TERMS_VASSAL_BASE_MULT = 1.5, -- only applied if the AI has vassalize priority
	...
	PEACE_TERMS_PROVINCE_BASE_MULT = 4.0,  
	PEACE_TERMS_TRADE_POWER_BASE_MULT = 0.1,
	PEACE_TERMS_HUMILIATE_BASE_MULT = 0.2,
	PEACE_TERMS_REVOKE_CORES_BASE_MULT = 0.25,
	PEACE_TERMS_REVOKE_REFORM_BASE_MULT = 0.5,
	PEACE_TERMS_RETURN_CORES_BASE_MULT = 0.5,
	PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.5,
	PEACE_TERMS_TRANSFER_VASSALS_BASE_MULT = 1.0,
	PEACE_TERMS_RELEASE_ANNEXED_BASE_MULT = 0.5,
	PEACE_TERMS_ANNUL_TREATIES_BASE_MULT = 0.25,  
	PEACE_TERMS_GOLD_BASE_MULT = 0.1,  
	PEACE_TERMS_GIVE_UP_CLAIM = 0.0,
	PEACE_TERMS_GIVE_UP_CLAIM_PERMANENT = 0.0,
	...
	PEACE_TERMS_TRIBUTARY_BASE_MULT = 1.5, -- Multiplies with strategic interest of making them our Tributary
	...
	PEACE_TERMS_PROVINCE_NO_CB_MULT = 1.0,  -- AI desire for a province is multiplied by this if it doesn't have a valid cb for it (only used when annexing, not applied to cores)
	PEACE_TERMS_PROVINCE_CORE_MULT = 1000.0, -- AI desire for a province is multiplied by this if it has a core on it
	PEACE_TERMS_PROVINCE_WARGOAL_MULT = 2.0, -- AI desire for a province is multiplied by this if it is the wargoal
	PEACE_TERMS_PROVINCE_CLAIM_MULT = 200.0, -- AI desire for a province is multiplied by this if it has a claim on it
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 0.80,  -- AI desire for a province is multiplied by this if it is not the same culture
	PEACE_TERMS_PROVINCE_VASSAL_MULT = 1.0,  -- AI desire for a province is multiplied by this if it would go to their vassal instead of themselves
	PEACE_TERMS_PROVINCE_REAL_ADJACENT_MULT = 2.0,  -- AI desire for a province is increased by this multiplier for each owned adjacent province
	...
	PEACE_TERMS_PROVINCE_NO_INTEREST_MULT = 1.0,  -- AI desire for a province is multiplied by this if it is not on their conquest list
	...
	PEACE_TERMS_REVOKE_CORE_FEAR_MULT = 1.25, -- AI desire for revoking cores is multiplied by this if they are afraid of the other country
	...
	DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_BASE_MULT = 100, -- AI scoring for offer condottieri, base scale.
	...
	DIPLOMATIC_ACTION_GUARANTEE_PROTECT_FACTOR = 2000, -- AI scoring for guarantee is changed by this if they have an attitude with the 'protect' desire
	DIPLOMATIC_ACTION_WARNING_MAX_DISTANCE = 50, -- AI will not warn if border distance is higher than this
	DIPLOMATIC_ACTION_WARNING_WARN_FACTOR = 100, -- AI scoring for warning is changed by this if they have an attitude with the 'warn' desire (multiplied by number of common neighbors )
